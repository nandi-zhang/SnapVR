...
public class TrajectoryPlanner : MonoBehaviour
{
    ...
    public void PublishJointsInCollaboration(Vector3 startPosition)
    {
        var request = new MoverServiceRequest();
        request.joints_input = CurrentJointConfig();
        ...
        request.pick_pose = new PoseMsg
        {
            position = (startPosition + m_PickPoseOffset).To<FLU>(),
    ...
    public void PublishJointsWithTargetOnSite(Vector3 endPosition)
    {
        var request = new MoverServiceRequest();
        request.joints_input = CurrentJointConfig();
        ...
        request.place_pose = new PoseMsg
        {
            position = (endPosition + m_PickPoseOffset).To<FLU>(),
            orientation = m_PickOrientation.To<FLU>()
        };

        m_Ros.SendServiceMessage<MoverServiceResponse>(m_RosServiceName, request, TrajectoryResponseWithTargetOnSite);
    }

    void TrajectoryResponseWithTargetOnSite(MoverServiceResponse response)
    {
        if (response.trajectories.Length > 0)
        {
            Debug.Log("Trajectory returned.");
            StartCoroutine(ExecuteTrajectoriesWithTargetOnSite(response));
        }
        else
        {
    ...
    IEnumerator ExecuteTrajectoriesWithTargetOnSite(MoverServiceResponse response)
    {
        ...
        EndPublishJointsWithTargetOnSite();
    }

    //////////////////////////END Target On Site//////////////////////////////

    public void EndPublishJointsWithTargetOnSite()
    {
        var request = new MoverServiceRequest();
        request.joints_input = CurrentJointConfig();
        ...
        request.pick_pose = new PoseMsg
        {
            position = (m_Target.transform.position + m_PickPoseOffset*1.5f).To<FLU>(),
        ...
        m_Ros.SendServiceMessage<MoverServiceResponse>(m_RosServiceName, request, EndTrajectoryResponseWithTargetOnSite);
    }

    void EndTrajectoryResponseWithTargetOnSite(MoverServiceResponse response)
    {
        if (response.trajectories.Length > 0)
        {
            Debug.Log("Trajectory returned.");
            StartCoroutine(EndExecuteTrajectoriesWithTargetOnSite(response));
        }
        else
        {
            Debug.Log("No trajectory returned from MoverService.");
    ...
    IEnumerator EndExecuteTrajectoriesWithTargetOnSite(MoverServiceResponse response)
    {
        if (response.trajectories != null)
        {
            // OpenGripper();
    ...
    //////////////////////Only Placement On Site////////////////////////////////////
    public void PublishJointsWithPlacementOnSite(Vector3 startPosition)
    {
        var request = new MoverServiceRequest();
        request.joints_input = CurrentJointConfig();
        ...
        m_Ros.SendServiceMessage<MoverServiceResponse>(m_RosServiceName, request, TrajectoryResponseWithPlacementOnSite);
    }

    void TrajectoryResponseWithPlacementOnSite(MoverServiceResponse response)
    {
        if (response.trajectories.Length > 0)
        {
            Debug.Log("Trajectory returned.");
            StartCoroutine(ExecuteTrajectoriesWithPlacementOnSite(response));
        }
        else
        {
            // PublishJoints();
    ...
    IEnumerator ExecuteTrajectoriesWithPlacementOnSite(MoverServiceResponse response)
    {
        if (response.trajectories != null)
        {
            OpenGripper();
